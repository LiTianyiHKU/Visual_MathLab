...
<p align="center">
  <a href="https://litianyihku.github.io/Visual_MathLab/">
    <img src="./docs/assets/surface-integral.jpg" alt="对坐标的曲面积分交互实验" width="920" />
  </a>
</p>

## 项目简介

Visual_MathLab 不是传统的静态数学笔记，而是一组可直接操作的数学实验场景。项目把“公式、图像、参数、运动过程”放到同一个界面中，让学习者通过拖动、切换、播放和观察，理解概念背后的几何、概率与分析结构。
...
<table>
  <tr>
    <td colspan="2">
      <img src="./docs/assets/surface-integral.jpg" alt="对坐标的曲面积分交互实验" />
    </td>
  </tr>
  <tr>
    <td colspan="2"><strong>对坐标的曲面积分</strong><br />旋转三维曲面，打开 xy / yz / xz 三个坐标面投影，观察向量场穿过曲面时对通量的贡献。</td>
  </tr>
  <tr>
    <td width="50%"><img src="./docs/assets/normal-2d.jpg" alt="二维正态分布交互实验" /></td>
    <td width="50%"><img src="./docs/assets/clt-dice.jpg" alt="中心极限定理骰子实验" /></td>
  </tr>
  <tr>
    <td><strong>二维正态分布</strong><br />调节均值、标准差与相关系数，观察密度曲面、等高线和协方差矩阵如何同步变化。</td>
    <td><strong>中心极限定理：骰子</strong><br />对比单个骰子结果与 30 个骰子均值的统计形状，直观看到均值分布如何趋近钟形。</td>
  </tr>
  <tr>
    <td width="50%"><img src="./docs/assets/eigen-diagonalization.jpg" alt="特征值、特征向量与相似对角化交互实验" /></td>
    <td width="50%"><img src="./docs/assets/fourier-series.jpg" alt="傅立叶级数交互实验" /></td>
  </tr>
  <tr>
    <td><strong>特征值、特征向量与相似对角化</strong><br />观察普通向量如何分解到特征方向上，并理解“换一套坐标轴”后的对角化意义。</td>
    <td><strong>傅立叶级数</strong><br />调整部分和项数，比较原函数、谐波分量与 N 项部分和的逼近过程。</td>
  </tr>
</table>
